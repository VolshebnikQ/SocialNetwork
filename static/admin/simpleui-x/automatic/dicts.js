...
var dicts = {
    ...
    //组
    'fas fa-users-cog': ['user', 'User', 'Учётные', 'учётные записи', 'Profile', 'profile'],
    //权限
    ...
    //网站
    'fas fa-globe-americas': ['网站', '网址', '站点', '官网', 'Сайты'],
    //评论
    ...
    'fa fa-folder-open': ['Filer', 'filer'],

    'fa fa-users': ['分组', '组合', '组队', '队伍', '队列', 'Group', 'group', 'Groups', 'groups', 'Группы', 'группы', 'Группа', 'группа'],

    'fa fa-link': ['URL-адрес'],

    'fa fa-search': ['Правилаиндексации'],

    'fa fa-folder': ['Папки'],

    'fa fa-object-group': ['Опцииминиатюры', 'опцииминиатюры', 'Опцииминиатюр'],

    'fas fa-user-friends': ['Друзья']
