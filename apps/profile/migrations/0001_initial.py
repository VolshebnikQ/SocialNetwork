    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(default='default_avatar.png', upload_to=apps.profile.models.User.imagepath)),
                ('sex', models.CharField(blank=True, choices=[('none', ' --- '), ('male', 'Мужской'), ('female', 'Женский')], max_length=6, null=True)),
